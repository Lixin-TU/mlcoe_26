...
from stochvol.stochvolprior import *
from stochvol.stochvolproposal import *
...
initparam = {"mu": 1, "rho": 0.9, "sigma": 0.4}
npart = 50
niter = 20
###################################################
...
pmmh = PMMH(initparam, model, prop, prior, step, N = niter, npart = npart, ESSresampling = True, resamplingmethod = "python")
